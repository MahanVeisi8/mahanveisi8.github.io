  ...
  <article class="project-card project-card--triple">
    ...
    <aside class="project-meta">
      <div class="repo-embed">
        <div class="repo-embed__header">
          <i class="fab fa-github"></i>
          <span class="repo-embed__name">
    ...
    <aside class="project-meta">
      <div class="repo-embed">
        <div class="repo-embed__header">
          <i class="fab fa-github"></i>
          <span class="repo-embed__name">
            <a href="https://github.com/SBUformers/Rock-Paper-Scissors-Simulator">
        ...
        <div class="repo-embed__header">
          ...
          <span class="repo-embed__name">
            <a href="https://github.com/MahanVeisi8/VAE-MNIST-Variable-Latent-Size-Reconstruction-and-Visualization">
              VAE-MNIST-Variable-Latent-Size-Reconstruction-and-Visualization
            </a>
          </span>
        </div>
        <div class="repo-embed__cardimg">
        ...
        <div class="repo-embed__header">
          ...
          <span class="repo-embed__name">
            <a href="https://github.com/MahanVeisi8/From-Chaos-to-Clarity-Denoising-Images-with-UNet-and-GANs">
              From-Chaos-to-Clarity-Denoising-Images-with-UNet-and-GANs
            </a>
          </span>
        </div>
        <div class="repo-embed__cardimg">
    ...
    <aside class="project-meta">
      <div class="repo-embed">
        <div class="repo-embed__header">
          <i class="fab fa-github"></i>
          <span class="repo-embed__name">
            <a href="https://github.com/MahanVeisi8/RL_practices">
              RL_practices
            </a>
          </span>
        </div>
    ...
    <aside class="project-meta">
      <div class="repo-embed">
        <div class="repo-embed__header">
          <i class="fab fa-github"></i>
          <span class="repo-embed__name">
            <a href="https://github.com/MahanVeisi8/FashionTagger">
              FashionTagger
            </a>
          </span>
        </div>
    ...
    <aside class="project-meta">
      <div class="repo-embed">
        <div class="repo-embed__header">
          <i class="fab fa-github"></i>
          <span class="repo-embed__name">
            <a href="https://github.com/MahanVeisi8/Face_recognition">
              Face_recognition
            </a>
          </span>
        </div>
    ...
    <aside class="project-meta">
      <div class="repo-embed">
        <div class="repo-embed__header">
          <i class="fab fa-github"></i>
          <span class="repo-embed__name">
            <a href="https://github.com/MahanVeisi8/MLPractices">
              MLPractices
            </a>
          </span>
        </div>
